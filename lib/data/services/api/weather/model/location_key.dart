/// Utility class for generating consistent location keys from geographic
/// coordinates.
///
...
class LocationKey {
  ...
  ///
  /// The coordinates are rounded to 2 decimal places to balance between
  /// precision and cache effectiveness. This ensures that users querying nearby
  /// locations retrieve cached results instead of triggering new API requests.
