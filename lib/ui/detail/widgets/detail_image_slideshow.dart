...
import 'package:moliseis/ui/detail/widgets/mountains_path_painter.dart';
import 'package:moliseis/ui/gallery/widgets/gallery_preview_modal.dart';
import 'package:moliseis/utils/constants.dart';
import 'package:moliseis/utils/extensions.dart';

part '_detail_image_slideshow_button.dart';

class DetailImageSlideshow extends StatefulWidget {
  const DetailImageSlideshow({required this.images});

  final List<Media> images;

  @override
  State<DetailImageSlideshow> createState() => _DetailImageSlideshowState();
}

class _DetailImageSlideshowState extends State<DetailImageSlideshow>
              ...
              children: [
                AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return _DetailImageSlideshowButton(
                      onPressed: () {
