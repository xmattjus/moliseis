import 'dart:ui' as ui show SemanticsRole;
...
///
/// {@tool dartpad}
/// This example shows a [AppNavigationBar] as it is used within a [Scaffold]
/// widget. The [AppNavigationBar] has three [NavigationDestination] widgets and
...
///
/// {@tool dartpad}
/// This example showcases [AppNavigationBar] label behaviors. When tapping on one
/// of the label behavior options, the [labelBehavior] of the [AppNavigationBar]
/// will be updated.
///
...
///
/// {@tool dartpad}
/// This example shows a [AppNavigationBar] within a main [Scaffold]
...
/// provides local navigation. The example's [AppNavigationBar] has four
...
class AppNavigationBar extends StatelessWidget {
  ...
  AppNavigationBar({
    ...
    this.fixedDestinationWidth = false,
  ...
  ///
  /// Upon updating [selectedIndex], the [AppNavigationBar] will be rebuilt.
  final ValueChanged<int>? onDestinationSelected;

  /// The color of the [AppNavigationBar] itself.
  ///
  ...
  /// The elevation of the [AppNavigationBar] itself.
  ///
  ...
  /// The height of the [AppNavigationBar] itself.
  ///
  ...
  ///
  /// When true, this will prevent the [AppNavigationBar] from shifting when opening a
  ...
  /// Whether the width of each destination should be fixed or not.
  ///
  /// When true, this will allow for extra space to be added to the ends of the
  /// navigation bar while centering the destination items in the middle of the
  /// navigation bar.
  ///
  /// Otherwise, the destination items will be spaced evenly across the entire
  /// width of the navigation bar.
  ///
  /// Defaults to false.
  final bool fixedDestinationWidth;
        ...
        child: Semantics(
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: <Widget>[
                if (fixedDestinationWidth) const Spacer(),
...
/// A Material 3 [AppNavigationBar] destination.
///
/// Displays a label below an icon. Use with [AppNavigationBar.destinations].
///
/// See also:
///
///  * [AppNavigationBar], for an interactive code sample.
class NavigationDestination extends StatelessWidget {
  /// Creates a navigation bar destination with an icon and a label, to be used
  /// in the [AppNavigationBar.destinations].
  const NavigationDestination({
    ...
    this.tooltip,
    this.enabled = true,
    this.indicatorHeight = _kIndicatorHeight,
    this.indicatorWidth = _kIndicatorWidth,
  });
...
class _NavigationDestinationBuilder extends StatefulWidget {
  /// Builds a destination (icon + label) to use in a Material 3 [AppNavigationBar].
  ...
  /// Builds the icon for a destination in a [AppNavigationBar].
  ///
  ...
  /// Builds the label for a destination in a [AppNavigationBar].
  ///
  /// To animate between unselected and selected, build the icon based on
...
/// Inherited widget for passing data from the [AppNavigationBar] to the
/// [AppNavigationBar.destinations] children widgets.
///
...
class _NavigationDestinationInfo extends InheritedWidget {
  ...
  ///
  /// This is computed by calling [AppNavigationBar.onDestinationSelected]
...
/// Selection Indicator for the Material 3 [AppNavigationBar] and [NavigationRail]
/// components.
///
...
/// Tooltip widget for use in a [AppNavigationBar].
///
