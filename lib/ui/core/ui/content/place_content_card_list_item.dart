...
class PlaceContentCardListItem extends StatelessWidget {
  const PlaceContentCardListItem(
    this.content, {
    super.key,
    this.color,
    this.elevation,
  ...
  Widget build(BuildContext context) {
    ...
    // size.
    final finalHeight = textScaleFactor > 1.5
        ? ((textScaleFactor - 1) * 30) + minHeight
        : minHeight;
